...
4. Formule no máximo 3 hipóteses (padrão de `debuggerMaxHypotheses` no
   executionBudget do manifest — se o projeto declarar outro valor lá,
   siga-o), ordenadas por probabilidade e custo do experimento que as
   testaria.
5. Para cada hipótese, defina o experimento mais barato que a refute
