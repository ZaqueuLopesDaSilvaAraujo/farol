...
| `memory.md` | histórico, preferência, pegadinha, regra de domínio ou aprendizado anterior puder afetar a tarefa atual |
| `workspace/{investigação}.md` | houver investigação ativa ou recentemente interrompida relacionada à tarefa |